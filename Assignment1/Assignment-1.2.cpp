...
int main()
{
	...
	//1
	if(sq_8[0]!=0 && sq_8[1]==0 && sq_8[3]!=0 && sq_8[5]!=0)
	{
		printf("(%c+%c+%c')",var_name[0],var_name[1],var_name[2]);
    }
	...
	//3
	if(sq_8[3]==0 && sq_8[1]!=0 && sq_8[7]!=0 && sq_8[2]!=0)
	{
		printf("(%c+%c'+%c')",var_name[0],var_name[1],var_name[2]);
    }
	...
	//2
	if(sq_8[2]==0 && sq_8[3]!=0 && sq_8[0]!=0 && sq_8[6]!=0)
	{
		printf("(%c+%c'+%c)",var_name[0],var_name[1],var_name[2]);
    }
	...
	//4
	if(sq_8[4]==0 && sq_8[0]!=0 && sq_8[6]!=0 && sq_8[5]!=0)
	{
		printf("(%c'+%c+%c)",var_name[0],var_name[1],var_name[2]);
    }
	...
	//5
	if(sq_8[5]==0 && sq_8[4]!=0 && sq_8[1]!=0 && sq_8[7]!=0)
	{
		printf("(%c'+%c+%c')",var_name[0],var_name[1],var_name[2]);
    }
	...
	//7
	if(sq_8[7]==0 && sq_8[3]!=0 && sq_8[5]!=0 && sq_8[6]!=0)
	{
		printf("(%c'+%c'+%c')",var_name[0],var_name[1],var_name[2]);
    }
	...
	//6
	if(sq_8[6]==0 && sq_8[7]!=0 && sq_8[2]!=0 && sq_8[4]!=0)
	{
		printf("(%c'+%c'+%c')",var_name[0],var_name[1],var_name[2]);
    }
    //quads
