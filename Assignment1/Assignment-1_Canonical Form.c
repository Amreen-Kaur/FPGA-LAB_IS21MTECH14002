...
int main()
{
	...
	if(sq_8[0]==0)
	{
		...
		if(sq_8[1]==0 || sq_8[2]==0 || sq_8[3]==0 || sq_8[4]==0 || sq_8[5]==0 || sq_8[6]==0 || sq_8[7]==0)
		{
			printf(".");
		}
	}
	...
	{
		printf("(%c+%c+%c')",var_name[0],var_name[1],var_name[2]);
		if(sq_8[2]==0 || sq_8[3]==0 || sq_8[4]==0 || sq_8[5]==0 || sq_8[6]==0 || sq_8[7]==0)
		{
			printf(".");
		}
	}
	...
	{
		printf("(%c+%c'+%c)",var_name[0],var_name[1],var_name[2]);
		if(sq_8[3]==0 || sq_8[4]==0 || sq_8[5]==0 || sq_8[6]==0 || sq_8[7]==0)
		{
			printf(".");
		}
	}
	...
	{
		printf("(%c+%c'+%c')",var_name[0],var_name[1],var_name[2]);
		if(sq_8[4]==0 || sq_8[5]==0 || sq_8[6]==0 || sq_8[7]==0)
		{
			printf(".");
		}
	}
